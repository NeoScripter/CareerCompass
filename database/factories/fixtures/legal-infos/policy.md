...
**Исполнитель** — Биленкин Дмитрий Викторович (ИНН 772395593636), применяющая специальный налоговый режим «Налог на профессиональный доход» (далее – «НПД»).  
**Сайт, Сайт Исполнителя** — [https://aiprofpath.ru/](https://aiprofpath.ru/)  
...
**1.2.** Исполнитель обрабатывает персональные данные Посетителей Сайта и Заказчиков исключительно в целях реализации Заказчикам Услуг в рамках Тарифов, представленных на Сайте Исполнителя.
...
**2.3.** Совершая действия на Сайте, Заказчик/Посетитель Сайта, тем самым, дает согласие на применение правил сбора и использования данных, изложенных в настоящем документе, в полном объеме.  
...
**3.1.1.** Исполнитель использует персонифицированную информацию конкретного Заказчика исключительно для обеспечения реализации выбранного Заказчиком Тарифа, а также учета количества Заказчиков по каждому из Тарифов.  
...
**5.1.** Сайт Исполнителя может содержать ссылки на другие сайты, не имеющие отношения к Исполнителю и принадлежащие третьим лицам. Исполнитель не несет ответственности за точность, полноту и достоверность сведений, размещенных на сайтах третьих лиц, и не берет на себя никаких обязательств по сохранению конфиденциальности информации, оставленной Посетителем Сайта/Заказчиком на таких сайтах.
...
**Биленкин Дмитрий Викторович**  
**ИНН:** 772395593636  
**Адрес электронной почты:** [dbilenkinb@yandex.ru](mailto:dbilenkinb@yandex.ru)
