...
class TestResultGenerator
{
    ...
    private function getFreeResponse(): array
    {
        return [
            ...
            'personalityDescription' => 'Вы — творческая личность с аналитическим складом ума. Вам нравится работать как самостоятельно, так и в команде. Вы обладаете высокой адаптивностью и стремитесь к постоянному развитию.',
            'jobs' => [
                $this->createJob(
                    'Веб-разработчик',
    ...
    private function getPremiumResponse(): array
    {
        ...
        return [
            ...
            'summary' => [
                ...
                $this->createSummary('Ваша сильная сторона — способность видеть большую картину, не теряя фокуса на деталях. Это делает вас идеальным кандидатом для позиций технического лидерства, где требуется как глубокая экспертиза, так и стратегическое видение.'),
                $this->createSummary('Основные области для развития связаны с балансом между личной экспертизой и делегированием, а также с необходимостью учитывать не только технические, но и человеческие и бизнес-аспекты принимаемых решений.'),
            ],
            'bestJob' => $bestJob,
            'jobAdvice' => [
    ...
    private function getFreePromptInstructions(): string
    {
        ...
        {
          "personalityItems": null,
          "personalityDescription": "строка 200-300 символов с общим описанием личности",
          "jobs": [
        ...
        {
          "personalityItems": null,
          "personalityDescription": "Вы обладаете аналитическим складом ума и творческим подходом к решению задач. Ваша способность быстро учиться и адаптироваться делает вас ценным специалистом в динамичных областях.",
          "jobs": [
            {
    ...
    private function getTopPromptInstructions(): string
    {
        ...
        - Более детальный анализ личности (250-350 символов)
    ...
    private function getPremiumPromptInstructions(): string
    {
        ...
        {
          "personalityItems": null,
          "personalityDescription": "строка 300-400 символов с максимально детальным описанием",
          "jobs": [
          ...
          "summary": [
            // Массив из 3-4 параграфов общего резюме
        ...
        - Максимально детальное описание личности (300-400 символов)
        ...
        ПРИМЕР ЧАСТИЧНОГО ОТВЕТА (bestJob, summary, jobAdvice):
        {
          ...
          "summary": [
            ...
            {
              "id": "b2c3d4e5-f6a7-5b6c-9d0e-1f2a3b4c5d6e",
              "description": "Ваша главная сила — умение балансировать между глубокой экспертизой и широким стратегическим видением. Это делает вас идеальным кандидатом для позиций технического лидерства, где требуется как понимание деталей реализации, так и способность видеть долгосрочную перспективу."
            },
            {
              "id": "c3d4e5f6-a7b8-6c7d-0e1f-2a3b4c5d6e7f",
              "description": "Области для развития связаны с необходимостью более эффективного делегирования и балансом между личной экспертизой и развитием команды. Также важно учитывать не только технические, но и политические аспекты корпоративной среды для максимизации вашего влияния."
            }
          ],
          "bestJob": {
            "id": "d4e5f6a7-b8c9-7d8e-1f2a-3b4c5d6e7f8a",
